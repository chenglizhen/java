 ...
 * @Description LinkedList 各种方法的测试Demo
 * @Author Cheng Lizhen
 * @Date 2019年3月15日 上午11:54:29
 */
public class LinkedListDemo {
	public static void main(String[] args) {
        ...
        System.out.println("get(0)获得指定位置（这里为0）的元素: " + linkedList.get(0)); // 返回此列表中指定位置处的元素
        ...
        System.out.println("After poll():" + linkedList);// 获取并移除此列表的头
        linkedList.remove();
